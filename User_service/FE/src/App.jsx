...
// import { UserPlus, Trash2, Users, Mail, Edit, Save, X, Phone, MapPin, Building2 } from 'lucide-react';
...
//   {/* Phone Number Field (Aluth) */}
//   <div className="flex-1 min-w-[200px]">
//     <label className="block text-xs uppercase tracking-wider text-slate-400 mb-1 ml-1">Phone Number</label>
//     <input className="w-full bg-slate-900 border border-slate-700 p-3 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none" 
...
//   {/* City Field (Aluth) */}
//   <div className="flex-1 min-w-[200px]">
//     <label className="block text-xs uppercase tracking-wider text-slate-400 mb-1 ml-1">City</label>
//     <input className="w-full bg-slate-900 border border-slate-700 p-3 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none" 
//       placeholder="City" value={formData.city} 
//       onChange={e => setFormData({...formData, city: e.target.value})} />
//   </div>

//   {/* Address Field (Aluth - Meka poodak diga nisa md:col-span-2 damma) */}
//   <div className="md:col-span-2">
//     <label className="block text-xs uppercase tracking-wider text-slate-400 mb-1 ml-1">Address</label>
//     <input className="w-full bg-slate-900 border border-slate-700 p-3 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none" 
...
//                   <th className="p-4 font-bold uppercase text-xs tracking-widest">Contact</th>
//                   <th className="p-4 font-bold uppercase text-xs tracking-widest">Location</th>
...
function App() {
  ...
  // ID එක අනුව දත්ත filter කිරීමේ logic එක
